...
local keymaps = {
    ["n|mm"] = map_cr("BookmarkToggle"):with_noremap():with_silent():with_desc("书签:在当前行添加/删除书签"),
    ["n|mi"] = map_cr("BookmarkAnnotate"):with_noremap():with_silent():with_desc("书签:添加/修改注释"),
    ["n|ma"] = map_cr("Telescope vim_bookmarks current_file"):with_noremap():with_silent():with_desc(
        "书签:查找当前文件下的书签"),
    ["n|mA"] = map_cr("Telescope vim_bookmarks all"):with_noremap():with_silent():with_desc(
        "书签:查找当前项目下的书签"),
