...
return {
    ...
    version = "1.*",
    event = "InsertEnter",
    dependencies = {"rafamadriz/friendly-snippets", "onsails/lspkind.nvim", "folke/lazydev.nvim",
                            ...
                            text = function(ctx)
                                ...
                                if ctx.source_name == 'minuet' then
                                    ...
                                    local function pick_icon(n)
                                        ...
                                        -- 构造一次性的小写映射
                                        local lc = {
                                            claude = kind_icons.claude,
                                            openai = kind_icons.openai,
                                            codestral = kind_icons.codestral,
                                            gemini = kind_icons.gemini,
                                            groq = kind_icons.Groq,
                                            openrouter = kind_icons.Openrouter,
                                            ollama = kind_icons.Ollama,
                                            llamacpp = kind_icons['Llama.cpp'],
                                            deepseek = kind_icons.Deepseek
                                        }
                                        return lc[k]
                                    end
