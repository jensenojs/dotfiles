...
lazy.setup({
    ...
    -- { import = "plugins.dap" },        -- AI 相关子目录
    -- { import = "plugins.diagnostics" },        -- AI 相关子目录
    {
        import = "plugins.file"
    }, -- 文件/检索/预览/大文件
    {
    ...
    -- { import = "plugins.tasks" },        -- AI 相关子目录
    {
        import = "plugins.terminal"
    }, -- 终端
    -- { import = "plugins.testing" },      -- AI 相关子目录
    {
    ...
    ui = {
        ...
        icons = (next(icons) and {
            ...
            list = icons.ui_sep and
                {icons.ui_sep.BigCircle, icons.ui_sep.BigUnfilledCircle, icons.ui_sep.Square, icons.ui_sep.ChevronRight} or
                {"●", "○", "■", ">"}
        }) or nil
    },
    change_detection = {
